<?php $this->use('templates/main.php',['title'=>'Ecomm | Color','mainPage'=>'Color','page'=>'Create Color']) ?>
                  ...
                  <div class="row">
                  	<div class="col-md-6">
                  		...
                  		<div class="form-group">
			                ...
			                <input type="text" class="form-control" placeholder="Enter Color Code" name="code">
                  		</div>
                  	</div>
                  </div>
                </div>
